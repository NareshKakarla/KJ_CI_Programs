...
def Run_a_sample_path(V, initial_location, P):
    ...
    Prop_algo_Param = [0,0]
    fixed_attempts = Fixed_attempts_count
...
# Main execution
def fixed_attempts_fun(runs,Initial_V,P_init):
...
#     service_requests, residual_energies, data_collection_rates = fixed_attempts_fun(runs, Initial_V, P_init)
...
#     plt.tight_layout()
#     plt.savefig("Fixed_metrics_distribution.pdf")
#     plt.show()