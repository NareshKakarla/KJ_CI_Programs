...
def Run_a_sample_path(V, initial_location, P):
    ...
    Prop_algo_Param = [0,0]
    rand_attempts = int(np.random.uniform(0, 20))
...
# Main execution
def random_attempts_fun(runs,Initial_V,P_init):
...
#     service_requests, residual_energies, data_collection_rates = random_attempts_fun(runs, Initial_V, P_init)
...
#     plt.tight_layout()
#     plt.savefig("Random_metrics_distribution.pdf")
#     plt.show()